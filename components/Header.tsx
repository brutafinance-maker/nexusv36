      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          <button 
            ...
            className={`p-2 rounded-lg transition-all ${currentView === 'biblioteca' ? 'text-sky-600 dark:text-nexus-blue bg-sky-50 dark:bg-nexus-blue/10' : 'text-neutral-400 dark:text-nexus-text-sec hover:text-neutral-900 dark:hover:text-nexus-text-title hover:bg-neutral-100 dark:hover:bg-nexus-surface'}`}
            title="Biblioteca"
          >
